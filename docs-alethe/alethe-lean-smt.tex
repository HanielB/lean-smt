...
check (\emph{valid}, not merely parseable). Of the remaining 691: 226 are steps \carcara's own checker rejects
(the identifiable ones 24 \rulename{and\_simplify} and 13
\rulename{ac\_simp}); 252 are holey, all \verit's oracle rule
...
230\,MB; and 62 exhaust the 12\,GB during the check or the elaboration.
