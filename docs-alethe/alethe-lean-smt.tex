...
\begin{figure}[t]
  ...
  \caption{Mean time per step of each rule, over the benchmarks whose
    ...
    largest total time, pooling the two solvers. Boxes are the quartiles and
    whiskers the 5th and 95th percentiles; the label above each group is the
    rule's total step count in the round. Note the log scale: \carcara sits
