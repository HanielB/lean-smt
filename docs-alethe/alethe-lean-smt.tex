...
proof of the empty clause: \cvcv answers unsatisfiable on 20\,033 benchmarks
but finishes printing the proof for 19\,191 of them, and \verit on 19\,192 and
19\,164 --- the difference is the solver being killed mid-print, and counting
it against the checkers would be counting a proof that does not exist.
\carcara accepts 19\,190 and 18\,688 of those proofs, and the checker
validates 16\,813 and 15\,870. Of the proofs the checker does not validate,
2\,327 and 2\,827 are timeouts, 8 and 49 exhaust its memory, 0 and 48 have a
trusted step, and 50 and 116 end in an error --- four front-end defects, three
of them since fixed, that Section~\ref{sec:revealed} takes apart. The checker's columns are independent verdicts on the same
...
quantified logics are nearly complete (99.7\% of UF and 99.6\% of UFLIA for
\cvcv) and QF\_LIA is at 93\%, while QF\_UF, whose proofs are an order of
magnitude larger, is at 58\% for both solvers, and QF\_IDL, whose
bounded-model-checking proofs are large too, at 57\% and 41\%.
...
The 842 benchmarks that separate \emph{unsat} from \emph{proof} are not
...
For \verit the gap is 476 proofs, down from 1\,344 in the previous round, and
it now splits four ways: 261 are holey, all \verit's oracle rule
\rulename{lia\_generic}, which carries no certificate and which \carcara does
not check either; 151 exceed \carcara's own 300\,s limit, on proofs of 130 to
230\,MB; 36 exhaust the 12\,GB during the check or the elaboration; and 28 are
proofs with a step \carcara's own checker rejects (27 \rulename{and\_simplify},
one \rulename{minus\_simplify}).

Two \carcara defects account for the 868 proofs the gap lost between the
rounds, and both are worth stating because each was mistaken for something
else first.
...
\begin{table}[p]
  ...
  \begin{tabular}{l l r r r @{\quad} r r r r @{\quad} r}
    ...
    \midrule
    \multirow{13}{*}{\cvcv}
      & QF\_UF    &   4\,361 &   4\,295 &   4\,295 &   2\,509 &  1\,780 &  6 &  0 & 140$\times$ \\
      & QF\_IDL   &      917 &      474 &      474 &      271 &     202 &  0 &  0 & 78$\times$ \\
      & QF\_RDL   &      113 &       73 &       73 &       38 &      35 &  0 &  0 & 140$\times$ \\
      & QF\_LIA   &   4\,748 &   2\,511 &   2\,511 &   2\,334 &     159 &  0 &  0 & 225$\times$ \\
      & QF\_LRA   &      703 &      525 &      525 &      417 &     108 &  0 &  0 & 92$\times$ \\
      & QF\_UFIDL &      422 &       38 &       38 &       30 &       8 &  0 &  0 & 2$\times$ \\
      & QF\_UFLIA &      192 &      172 &      172 &      163 &       7 &  0 &  0 & 248$\times$ \\
      & QF\_UFLRA &      511 &      441 &      441 &      432 &       9 &  0 &  0 & 27$\times$ \\
      & UF        &   3\,505 &   3\,155 &   3\,155 &   3\,146 &       7 &  2 &  0 & 358$\times$ \\
      & UFIDL     &       53 &       53 &       53 &       53 &       0 &  0 &  0 & 700$\times$ \\
      & UFLIA     &   7\,793 &   7\,444 &   7\,443 &   7\,410 &      12 &  0 &  0 & 210$\times$ \\
      & UFLRA     &       10 &       10 &       10 &       10 &       0 &  0 &  0 & --- \\
    \cmidrule(l){2-10}
      & total     &  23\,328 &  19\,191 &  19\,190 &  16\,813 &  2\,327 &  8 &  0 & 214$\times$ \\
    \midrule
    \multirow{13}{*}{\verit}
      & QF\_UF    &   4\,361 &   4\,188 &   4\,174 &   2\,437 &  1\,737 &  0 &  0 & 543$\times$ \\
      & QF\_IDL   &      917 &      635 &      538 &      218 &     303 &  8 &  0 & 62$\times$ \\
      & QF\_RDL   &      113 &       87 &       77 &       37 &      40 &  0 &  0 & 94$\times$ \\
      & QF\_LIA   &   4\,748 &   2\,604 &   2\,327 &   2\,229 &     210 &  7 & 10 & 715$\times$ \\
      & QF\_LRA   &      703 &      579 &      578 &      424 &     154 &  0 &  0 & 176$\times$ \\
      & QF\_UFIDL &      422 &      270 &      265 &       67 &     165 &  0 &  0 & 599$\times$ \\
      & QF\_UFLIA &      192 &      173 &      130 &      171 &       2 &  0 &  0 & 664$\times$ \\
      & QF\_UFLRA &      511 &      415 &      415 &      349 &      66 &  0 &  0 & 91$\times$ \\
      & UF        &   3\,505 &   2\,897 &   2\,881 &   2\,861 &       3 & 16 &  1 & 451$\times$ \\
      & UFIDL     &       53 &       51 &       51 &       51 &       0 &  0 &  0 & 1\,479$\times$ \\
      & UFLIA     &   7\,793 &   7\,255 &   7\,242 &   7\,016 &     147 & 18 & 37 & 530$\times$ \\
      & UFLRA     &       10 &       10 &       10 &       10 &       0 &  0 &  0 & --- \\
    \cmidrule(l){2-10}
      & total     &  23\,328 &  19\,164 &  18\,688 &  15\,870 &  2\,827 & 49 & 48 & 496$\times$ \\
    \bottomrule
  \end{tabular}
\end{table}
...
--- 12\,733 for \cvcv and 9\,559 for \verit --- the checker is a median of
214$\times$ and 496$\times$ slower (geometric mean 191$\times$ and
498$\times$; ninetieth percentile 433$\times$ and 1\,193$\times$).
Elaboration is not what costs: comparing the two checks alone moves the
medians to 212$\times$ and 494$\times$. The factor varies by an order of
magnitude across logics (last column of Table~\ref{tab:smtlib}), and it is
smallest exactly where the proofs are largest --- 140$\times$ in QF\_UF
against 358$\times$ in UF --- because the checker pays a fixed five-second
...
against 54\,s and 0.14\,s against 48\,s, and the timeouts sit above proofs
\carcara disposes of in a second or two. Over the round \carcara spends 9.7
and 8.9 CPU hours and the checker 199 and 188. That is the price of a proof
...
reaches: below 10\,000 elaborated steps the checker times out on 0.4\% of
\cvcv proofs and 1.3\% of \verit ones, between 20\,000 and 50\,000 on 73\%
and 93\%, and above 50\,000 on essentially all of them.
...
\carcara needs for every proof it accepts, solving included (26.7 CPU hours
for \cvcv, 18.5 for \verit), the checker validates the first 12\,661 and
11\,512 of them.
...
\begin{figure}[t]
  ...
  \caption{Cumulative solving and checking time against the number of SMT-LIB
    ...
    19\,190 \cvcv proofs in 26.7 CPU hours and 18\,688 \verit proofs in 18.5;
    the checker validates 16\,813 and 15\,870 in 206 and 192.}
  \label{fig:cactus}
\end{figure}

\paragraph{What is left.} Rule coverage is essentially complete and the
residue is small enough to enumerate. \cvcv leaves no proof with a trusted
step at all. \verit leaves 48: 32 \rulename{distinct\_elim} steps over the
large enumerations of the ESC/Java benchmarks, 10 \rulename{lia\_generic},
\verit's oracle rule, closed by \texttt{omega} when in its fragment and
trusted otherwise, and 6 \rulename{th\_resolution}. Every case the previous
round left except \rulename{lia\_generic} has a fix and a regression test:
\rulename{evaluate} over equalities between propositions, where \texttt{=} on
\texttt{Prop} has no computable decidability instance, is now rewritten to
\texttt{↔} before evaluating; \rulename{distinct\_elim}'s pairwise conversion,
which embedded the whole conjunct list in each of $n^2$ projections, is now
proved by congruence on the conjunction; and the
\rulename{bool\_simplify} steps \carcara's core pass had left unreduced are
reduced (Section~\ref{sec:carcara}). The 50 and 116 errors are not the same
phenomenon as the timeouts, as the previous round assumed of the memory
exhaustions among them; Section~\ref{sec:revealed} takes them apart. The rest is scale: the timeouts, whose remedy is the
reflective resolution checker described in the accompanying notes, not a rule.

\subsection{Where the Time Goes, Rule by Rule}
\label{sec:perrule}

The 214$\times$ and 496$\times$ of the previous section are whole-proof
...
out. First, the gap is not uniform: it runs from about 150$\times$ on
\rulename{rare\_rewrite} and \rulename{distinct\_elim}, where the checker
replays a rewrite it can name, to four or five orders of magnitude on the
small clausal rules --- \rulename{and}, \rulename{or\_neg},
\rulename{equiv\_pos2} --- where \carcara compares two
...
Second, one rule dominates the total: \rulename{resolution} is 51\% of the
checker's time, and \rulename{and} a further 14\%. This is the quantitative
form of the claim that the remedy for the timeouts is a reflective resolution
checker rather than better rule reconstructions --- no amount of work on the
arithmetic or rewriting rules moves a number half of which is one rule.

Third, the structural AC rules that replaced \rulename{aci\_simp}
(Section~\ref{sec:carcara}) are cheap on both sides:
\rulename{semilattice\_simp} at a median of 3.3\,ms and \rulename{poly\_simp}
at 12\,ms for the checker, with a ratio under 1\,000$\times$, better than the
clausal rules they are glued to. Splitting \rulename{aci\_simp} into rules
...
\begin{figure}[t]
  ...
  \caption{Mean time per step of each rule, over the benchmarks whose
    elaborated proof both checkers accept, for the fourteen rules with the
    largest total time. Boxes are the quartiles and whiskers the 5th and 95th
    percentiles; the label above each group is the rule's total step count in
    the round. Note the log scale: the two \carcara series sit three to four
    decades below the two \tactic ones.}
  \label{fig:rules}
\end{figure}
...
\paragraph{The failures the round leaves.} Beyond the timeouts, 50 \cvcv and
116 \verit runs end in an error, and they are four distinct defects of the
checker's front end rather than of any rule. Three are now fixed.
...
checks the 15\,MB benchmark in 190\,s.
...
clause's own polarity. The remaining 6, and \verit's 49, are one step too
large rather than a loop.

Two groups are not fixed. 15 \cvcv proofs, 13 of them in QF\_LIA's
\texttt{incrementalScheduling}, need higher-order reasoning the checker does
not have: \cvcv keeps a parameterised \texttt{define-fun} as an uninterpreted
...
\texttt{define-fun}s as functions rather than expanding them. And 40 \verit
proofs, 30 in QF\_UFIDL's \texttt{pete2}, fail to synthesize a
\texttt{Decidable} instance for a deeply nested ground \texttt{ite} chain over
integer differences --- a \rulename{evaluate}-adjacent case where the term is
decidable in principle but instance search does not get there.
...
\begin{table}[p]
  ...
  \caption{The per-step shape against its \texttt{native} variant on the
    ...
    (8 and 49 memory failures, 0 and 48 proofs with a trusted step). The last column is the median ratio of \texttt{native}'s
  ...
  \begin{tabular}{l l r r @{\quad} r r @{\quad} r r r @{\quad} r}
    ...
    \midrule
    \multirow{13}{*}{\cvcv}
      & QF\_UF    &   2\,509 &  1\,780 &   2\,506 &  1\,783 &   2\,505 &  4 &  1 & 0.993 \\
      & QF\_IDL   &      271 &     202 &      271 &     202 &      271 &  0 &  0 & 0.956 \\
      & QF\_RDL   &       38 &      35 &       39 &      34 &       38 &  0 &  1 & 0.830 \\
      & QF\_LIA   &   2\,334 &     159 &   2\,347 &     146 &   2\,334 &  0 & 13 & 0.848 \\
      & QF\_LRA   &      417 &     108 &      421 &     104 &      416 &  1 &  5 & 0.854 \\
      & QF\_UFIDL &       30 &       8 &       30 &       8 &       30 &  0 &  0 & 0.944 \\
      & QF\_UFLIA &      163 &       7 &      164 &       6 &      163 &  0 &  1 & 0.886 \\
      & QF\_UFLRA &      432 &       9 &      432 &       9 &      431 &  1 &  1 & 0.966 \\
      & UF        &   3\,146 &       7 &   3\,146 &       7 &   3\,146 &  0 &  0 & 0.919 \\
      & UFIDL     &       53 &       0 &       53 &       0 &       53 &  0 &  0 & 0.926 \\
      & UFLIA     &   7\,410 &      12 &   7\,410 &      12 &   7\,410 &  0 &  0 & 0.908 \\
      & UFLRA     &       10 &       0 &       10 &       0 &       10 &  0 &  0 & 0.867 \\
    \cmidrule(l){2-10}
      & total     &  16\,813 &  2\,327 &  16\,829 &  2\,311 &  16\,807 &  6 & 22 & 0.92 \\
    \midrule
    \multirow{13}{*}{\verit}
      & QF\_UF    &   2\,437 &  1\,737 &   2\,440 &  1\,734 &   2\,436 &  1 &  4 & 0.988 \\
      & QF\_IDL   &      218 &     303 &      219 &     302 &      217 &  1 &  2 & 0.981 \\
      & QF\_RDL   &       37 &      40 &       41 &      36 &       37 &  0 &  4 & 0.943 \\
      & QF\_LIA   &   2\,229 &     210 &   2\,218 &     220 &   2\,218 & 11 &  0 & 0.868 \\
      & QF\_LRA   &      424 &     154 &      428 &     150 &      424 &  0 &  4 & 0.867 \\
      & QF\_UFIDL &       67 &     165 &       67 &     164 &       67 &  0 &  0 & 0.990 \\
      & QF\_UFLIA &      171 &       2 &      171 &       2 &      171 &  0 &  0 & 0.948 \\
      & QF\_UFLRA &      349 &      66 &      348 &      67 &      348 &  1 &  0 & 1.003 \\
      & UF        &   2\,861 &       3 &   2\,861 &       3 &   2\,861 &  0 &  0 & 0.905 \\
      & UFIDL     &       51 &       0 &       51 &       0 &       51 &  0 &  0 & 0.941 \\
      & UFLIA     &   7\,016 &     147 &   7\,016 &     147 &   7\,016 &  0 &  0 & 0.918 \\
      & UFLRA     &       10 &       0 &       10 &       0 &       10 &  0 &  0 & 0.882 \\
    \cmidrule(l){2-10}
      & total     &  15\,870 &  2\,827 &  15\,870 &  2\,825 &  15\,856 & 14 & 14 & 0.92 \\
    \bottomrule
  \end{tabular}
\end{table}

\paragraph{Outcomes.} Table~\ref{tab:native} gives the round per logic.
\texttt{native} validates 16 more \cvcv proofs (16\,829 against 16\,813) and
exactly as many \verit ones (15\,870), a tenth of a percent of either
population at most, and what gain there is is timeouts avoided: 2\,327 fall to
2\,311 and 2\,827 to 2\,825. Nothing else moves. The memory failures are the
same 8 and 49 runs, the proofs with a trusted step the same 0 and 48, and no
...
handful, and the paired counts say why: 16\,807 (\cvcv) and 15\,856 (\verit)
proofs are validated by both arms, 22 and 14 by \texttt{native} only, 6 and 14
...
\texttt{native} is faster on 91.5\% (\cvcv) and 92.1\% (\verit) of them, and
the median ratio of its CPU time to the plain arm's is 0.92 for both solvers,
with the middle half of the proofs between 0.87 and 0.97. Summed, 194.1 CPU
hours become 185.8 and 182.7 become 179.0. Figure~\ref{fig:nativekernel}
isolates the kernel's share of that: its median falls from 650 to 448\,ms per
\cvcv proof and from 596 to 510\,ms per \verit one, 124.7 CPU hours to 113.8
and 125.0 to 120.8, but it still accounts for 61\% and 68\% of each arm's time
against 64\% and 68\% before. The saving is a slice of the kernel's work rather than most of it,
...
the last column of Table~\ref{tab:native} locate the gain exactly: 0.83 to
