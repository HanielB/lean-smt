...
keeps its strict structural reading. The affected proofs --- 175 QF\_UFIDL
(\texttt{pete2}, \texttt{pete}, \texttt{uclid}) and 24 QF\_LIA --- now check,
and the step is decomposed into \rulename{cong}, \rulename{trans} and
\rulename{semilattice\_simp}, which the checker already reconstructs; no
lean-smt change was needed. The identifiable remainder is 24
