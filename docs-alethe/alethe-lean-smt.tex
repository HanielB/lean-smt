...
and 15\,334. Of the proofs it does not validate, 2\,287 and 2\,494 are
timeouts and 2 and 54 have a trusted step; the two counts are independent
verdicts on the same proof, which is why the checker validates more QF\_UFLIA
\verit proofs than \carcara accepts --- \carcara reports a proof with a
\rulename{lia\_generic} step holey, and the checker closes that step with
...
\begin{table}[t]
  ...
  \caption{The SMT-LIB round, 23\,328 benchmarks per solver. \emph{unsat} is
    what the solver proved; \carcara the proofs it accepts; \tactic the proofs
    the checker validates with no trusted step, with its timeouts and its
    proofs with a trusted step (\emph{holey}).}
  \label{tab:smtlib}
  \small
  \begin{tabular}{l r @{\quad} r r r r r @{\quad} r r r r r}
    \toprule
    & & \multicolumn{5}{c}{\cvcv} & \multicolumn{5}{c}{\verit} \\
    \cmidrule(lr){3-7} \cmidrule(lr){8-12}
    logic & bench. & unsat & \carcara & \tactic & t/o & holey
                   & unsat & \carcara & \tactic & t/o & holey \\
    \midrule
    QF\_UF    & 4\,361 & 4\,324 & 4\,296 & 2\,527 & 1\,763 & 0 & 4\,193 & 4\,175 & 2\,446 & 1\,729 & 0 \\
    QF\_IDL   &    917 &    633 &    475 &    276 &    196 & 2 &    645 &    538 &    222 &    293 & 0 \\
    QF\_RDL   &    113 &     88 &     74 &     39 &     35 & 0 &     95 &     28 &     15 &     13 & 0 \\
    QF\_LIA   & 4\,748 & 2\,794 & 2\,511 & 2\,341 &    152 & 0 & 2\,611 & 2\,314 & 2\,220 &    187 & 10 \\
    QF\_LRA   &    703 &    582 &    526 &    425 &    101 & 0 &    580 &    387 &    282 &    105 & 0 \\
    QF\_UFIDL &    422 &    268 &     38 &     30 &      8 & 0 &    271 &     64 &     47 &     16 & 0 \\
    QF\_UFLIA &    192 &    174 &    172 &    166 &      4 & 0 &    173 &    130 &    172 &      1 & 0 \\
    QF\_UFLRA &    511 &    511 &    441 &    432 &      9 & 0 &    415 &      3 &      3 &      0 & 0 \\
    UF        & 3\,505 & 3\,155 & 3\,155 & 3\,145 &      7 & 0 & 2\,897 & 2\,881 & 2\,860 &      3 & 1 \\
    UFIDL     &     53 &     53 &     53 &     53 &      0 & 0 &     51 &     51 &     51 &      0 & 0 \\
    UFLIA     & 7\,793 & 7\,445 & 7\,443 & 7\,409 &     12 & 0 & 7\,255 & 7\,242 & 7\,006 &    147 & 43 \\
    UFLRA     &     10 &     10 &     10 &     10 &      0 & 0 &     10 &     10 &     10 &      0 & 0 \\
    \midrule
    total     & 23\,328 & 20\,037 & 19\,194 & 16\,853 & 2\,287 & 2 & 19\,196 & 17\,823 & 15\,334 & 2\,494 & 54 \\
    \bottomrule
  \end{tabular}
\end{table}
...
checker's check of the elaborated one. \carcara checks a proof in a median of
0.04\,s (\cvcv) and 0.01\,s (\verit), the checker in 5.8\,s and 5.2\,s ---
of which about five seconds is the fixed cost of loading the library, so the
proofs of the quantified logics cost it almost nothing beyond that --- and the
ratio grows with the proof: in QF\_UF the medians are 0.78\,s against 52\,s
and 0.14\,s against 45\,s, and the timeouts sit above proofs \carcara disposes
of in a second or two. Over the round \carcara spends 9.6 and 6.5 CPU hours
and the checker 198 and 143. That is the price of a proof term the kernel
accepts, and it makes the interesting question not whether the checker
competes with a dedicated one but how far up the size distribution it
reaches: the timeouts start around 20\,000 elaborated steps and are the
rule above 50\,000.
...
otherwise. All but the last are fixed, with a regression test each, and the
...
one and three timeouts. What limits the round is the solver, not the checker
--- 2\,869 and 2\,681 of the 5\,000 problems are proved unsatisfiable at all
--- and, for \verit, \carcara's own check, which rejects 83 proofs.
...
\begin{table}[t]
  ...
  \caption{The Sledgehammer round, 5\,000 problems per solver; the columns of
    ...
    proofs it validates (elaboration included for \tactic).}
  \label{tab:seventeen}
  \begin{tabular}{l r r r r r @{\qquad} r r}
    \toprule
    solver & unsat & \carcara & \tactic & t/o & holey & \carcara h & \tactic h \\
    \midrule
    \cvcv  & 2\,869 & 2\,868 & 2\,858 & 1 &  9 & 0.04 & 4.5 \\
    \verit & 2\,681 & 2\,598 & 2\,520 & 3 & 51 & 0.02 & 3.8 \\
    \bottomrule
  \end{tabular}
\end{table}
...
checking, which is why the points form a horizontal band. Over the round the
checker costs 4.5 and 3.8 CPU hours, against 72.2 and 92.8 hours of solving.
