...
register_option smt.alethe.coreRules : String := {
  defValue := "ite_simplify eq_simplify not_simplify implies_simplify equiv_simplify bool_simplify comp_simplify and_simplify or_simplify prod_simplify sum_simplify minus_simplify unary_minus_simplify div_simplify ac_simp aci_simp absorb"
